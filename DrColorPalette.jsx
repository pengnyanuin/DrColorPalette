...
(function DrColorPalette(thisObj) {
    ...
    function createUI() {
        ...
        backButton.onClick = function() {
            ...
            // Change focus to viewer panel to prevent buttons going blue
        ...
        win.onResize = function () {
            generateColorFields(groupTwo, win); // this.layout.resize() would be a replicate
        };
        return win;
    }
    ...
    function generateColorFields(group, win) {
        ...
        var colorsPerRow = 4;
        var windowWidth = win.size;
        if (windowWidth !== undefined) {
            windowWidth = windowWidth[0] - 2; // Remove one margin border
            var newColorsPerRow = Math.floor(windowWidth/32);
            if (newColorsPerRow > colorsPerRow) {
                colorsPerRow = newColorsPerRow;
            }
        }
        ...
        for (var i = 0; i < COLOR_COUNTER; i++) (function(i) {
            if (wrapperGroup === null || i % colorsPerRow === 0) {
